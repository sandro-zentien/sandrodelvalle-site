  ...
  en: {
    ...
    projects: {
      ...
      cards: {
        ...
        tripflow:   { tagline: 'AI-Powered Social Travel App',           description: 'A social travel app that turns group travel planning into a shared experience. AI recommends destinations, builds day-by-day itineraries, finds places to eat and explore, and adapts plans on the fly — all built around the people you travel with. Available as a PWA with a full React Native + Expo mobile app in development.',                                                                                                              urlLabel: 'Coming Soon'                 },
        ...
        more:       { name: 'Always Building. Always Learning.', tagline: 'More Projects', description: 'New ideas in progress across different domains and technologies. This list keeps growing — it always has. Follow along on GitHub to see what comes next.',                                                                                                                                                                                                                                                                           urlLabel: 'github.com/sandro-zentien'   },
      },
    },
  ...
  es: {
    ...
    projects: {
      ...
      cards: {
        ...
        tripflow:   { tagline: 'App de Viajes Social con IA',               description: 'Una app de viajes social que convierte la planificación grupal en una experiencia compartida. La IA recomienda destinos, construye itinerarios día a día, encuentra lugares para comer y explorar, y adapta los planes sobre la marcha — todo construido alrededor de las personas con quienes viajas. Disponible como PWA con una app móvil en React Native + Expo en desarrollo.',                                                              urlLabel: 'Próximamente'                },
        ...
        more:       { name: 'Siempre Construyendo. Siempre Aprendiendo.', tagline: 'Más Proyectos', description: 'Nuevas ideas en progreso en distintos dominios y tecnologías. Esta lista sigue creciendo — siempre ha sido así. Sígueme en GitHub para ver qué viene después.',                                                                                                                                                                                                                                                          urlLabel: 'github.com/sandro-zentien'   },
      },
    },

export const t = {
  en: {
    ...
    projects: {
      ...
      cards: {
        ...
        scorewell:  { tagline: 'Health & Benefits Platform',            description: 'A private health platform built for MGM — connects HR, employees, health coaches, and doctors. Calculates a personalized health score based on lab results and delivers tailored recommendations from certified health coaches.',                                                                                                                                                                                                                          urlLabel: 'Private / Client Project'    },
  ...
  es: {
    ...
    about: {
      ...
      h3: 'desde',
      h4: 'Miami',
      bio1: "A los cinco años, mi vecino tenía una computadora — y en Cuba, eso era un secreto. Cada día cruzaba la calle, atravesaba cuartos llenos con los cuadros del padre de ella, y llegaba hasta la habitación del fondo donde vivía esa máquina. Me sentaba ahí durante horas, aprendiendo a hacerla funcionar. Esa sensación nunca me abandonó.",
